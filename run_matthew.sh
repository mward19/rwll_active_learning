...
python test_al_gl.py --dataset mnistimb-mod3 --K 30 --config config_matthew.yaml --resultsdir results --iters 3
python accuracy_al_gl.py --dataset mnistimb-mod3 --config config_matthew.yaml --resultsdir results --iters 3
python compile_summary.py --dataset mnistimb-mod3 --resultsdir results --iters 3
...
# python test_al_gl_voptfull.py --dataset mnist-mod3 --config config_full.yaml --resultsdir results
# python accuracy_al_gl.py --dataset mnist-mod3 --config config_full.yaml --resultsdir results
# python compile_summary.py --dataset mnist-mod3 --resultsdir results

# python test_al_gl_voptfull.py --dataset fashionmnist-mod3 --config config_full.yaml --resultsdir results 
# python accuracy_al_gl.py --dataset fashionmnist-mod3 --config config_full.yaml --resultsdir results
# python compile_summary.py --dataset fashionmnist-mod3 --resultsdir results

# python test_al_gl_voptfull.py --dataset mnistimb-mod3 --config config_full.yaml --resultsdir results 
# python accuracy_al_gl.py --dataset mnistimb-mod3 --config config_full.yaml --resultsdir results
# python compile_summary.py --dataset mnistimb-mod3 --resultsdir results

#python test_al_gl_voptfull.py --dataset fashionmnistimb-mod3 --config config_full.yaml --resultsdir results 
#python accuracy_al_gl.py --dataset fashionmnistimb-mod3 --config config_full.yaml --resultsdir results
#python compile_summary.py --dataset fashionmnistimb-mod3 --resultsdir results
